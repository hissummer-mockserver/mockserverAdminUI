...
<div>
    ...
    <Input class="input" v-model="category" placeholder="分组" style="width: 300px" />
    <Input class="input" v-model="hostName" placeholder="hostName: 例如*" style="width: 300px" />
    ...
    <Modal width="600px" :mask-closable="false" v-model="addRuleModal" :title="modalTitle" @on-ok="addOk" @on-cancel="cancel">
        ...
        <div>
            ...
            <Input v-model="addRule.category" placeholder="mock规则的分组" style="width: 400px" />
        </div>
        ...
        <div>
            ...
            <div v-if="showUpstreamMode">
                <div class="nextedForm">
                    ...
                    <Input disabled v-model="addRule.upstreams.nodes[0].address" placeholder="localhost:8081" style="width:150px" />
